...
INSERT INTO states (code) VALUES ('週末の町と過ごし方') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('コーバリス：ハイキング(Alsea Falls, Marys Peak)、農家市場(土水)、ワイナリー・醸造所、野生動物保護区、パブリックアート') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('サンフランシスコ全体！ゴールデンゲート、フィッシャーマンズワーフ、チャイナタウン、近代美術館、ハイキング、ナパバレー日帰り') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('フラッシング・クイーンズ：アジア系食文化豊富(中国・韓国・インド料理)、メドウ・コロナ・パーク、USテニスセンター、マンハッタンへのアクセス容易') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('タラハシー(州都)：FSU CollegeTown(飲食・ライブ音楽)、Cascades Park(屋外コンサート)、Railroad Square(アート地区)、District 850(ボウリング・アーケード)') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('ポーキプシー(ハドソン川沿い)：Walkway Over Hudson(世界最長歩行者橋)、ファーマーズマーケット、醸造所、Bardavon Opera House、ゲティスバーグ(10分)、フレデリック(25分)') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('ティーネック(NYCから25マイル)：映画館、ライブ音楽(Mexicali Live)、公園(Votee Park)、蝶館') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('コーラルゲーブルズ：Miracle Mile(ショッピング・ダイニング)、Gablestage(映画館)、Fairchild植物園、月初金曜アート夜(無料)、ビーチ') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('エミッツバーグ：Ott House Pub(ビール・音楽)、Catoctin Mountain Park(ハイキング)、Cunningham Falls(滝・水泳)、ゲティスバーグ(10分)、フレデリック(25分・マイナーリーグ野球)') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('サンルイスオビスポ：ダウンタウン探索、Bishop Peak登山、木曜農家市場、ワイナリー(Edna Valley)、ビーチ(20分)、醸造所') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('サンタバーバラ：サーフィン(Rincon Point)、パドルボード(Harbor)、Funk Zone(飲食・醸造所30軒)、日曜アート(200+アーティスト)、ホエールウォッチング') ON CONFLICT (code) DO NOTHING;
INSERT INTO states (code) VALUES ('フラートン・オレンジ郡：Fullerton Arboretum(26エーカー)、Downtown Fullerton(ナイトライフ)、Newport Bay(パドルボード)、Huntington Beach(30分)、Tanaka Farms') ON CONFLICT (code) DO NOTHING;
...
INSERT INTO states (code) VALUES ('州') ON CONFLICT (code) DO NOTHING;
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('人種比率', '施設', '留学生支援', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='週末の町と過ごし方'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='施設' LIMIT 1), 'カンファレンス順位', '投手育成', 'カンファレンス順位 投手育成', '野球施設', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人61%, ヒスパニック17%, アジア7%, 黒人2%, 留学生2%', 'Dixon Recreation Center：2カーディオルーム、2ウェイトルーム、クライミングウォール42ft、屋内トラック、25ydプール、3サンドバレーコート、40+スポーツクラブ', 'Office of International Services(OIS)：約2100名サポート。ビザ・移民相談、オンボーディング支援', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='コーバリス：ハイキング(Alsea Falls, Marys Peak)、農家市場(土水)、ワイナリー・醸造所、野生動物保護区、パブリックアート'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Dixon Recreation Center：2カーディオルーム、2ウェイトルーム、クライミングウォール42ft、屋内トラック、25ydプール、3サンドバレーコート、40+スポーツクラブ' LIMIT 1), 'Pac-12系 / 2025年：41勝12敗1分、全国No.8シード', '野球発展センター(2024秋開設)：10000sqft屋内施設、4つの打撃・投球ベイ、重量挙げ・有酸素完備', 'Pac-12系 / 2025年：41勝12敗1分、全国No.8シード 野球発展センター(2024秋開設)：10000sqft屋内施設、4つの打撃・投球ベイ、重量挙げ・有酸素完備', 'Goss Stadium at Coleman Field + 新Baseball Development Center(2024秋)', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人26%, アジア23%, 黒人7%, BIPOC73%, 留学生11%(977名)。多様性全米1位', 'Benedetti Diamond(野球場)：NCAA D1唯一の有機充填施設。2015年$600万改修。Phase2で新クラブハウス・屋内打撃施設計画中', 'ISSS：ビザ・移民アドバイス、F-1/J-1サポート、税務申告支援、異文化交流。isss@usfca.edu', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='サンフランシスコ全体！ゴールデンゲート、フィッシャーマンズワーフ、チャイナタウン、近代美術館、ハイキング、ナパバレー日帰り'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Benedetti Diamond(野球場)：NCAA D1唯一の有機充填施設。2015年$600万改修。Phase2で新クラブハウス・屋内打撃施設計画中' LIMIT 1), 'WCC / 2025年：26勝30敗、WCC6位。DiToma監督下で最多シリーズ勝利', '5選手All-WCC受賞(2025)。具体的投手育成プログラム情報は限定的', 'WCC / 2025年：26勝30敗、WCC6位。DiToma監督下で最多シリーズ勝利 5選手All-WCC受賞(2025)。具体的投手育成プログラム情報は限定的', 'Benedetti Diamond：有機充填最新施設。将来的に屋内打撃施設予定', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人22%, アジア30%, 黒人9%, BIPOC71%。170カ国から600-650名の国際学生', 'FitzGerald Gym、Olympic規模室内プール(6レーン)、フィットネスセンター、テニスコート(室内外)', 'ISS Office(King Hall 207)：ビザ維持、オリエンテーション、銀行・保険・税金相談。iss@qc.cuny.edu', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='フラッシング・クイーンズ：アジア系食文化豊富(中国・韓国・インド料理)、メドウ・コロナ・パーク、USテニスセンター、マンハッタンへのアクセス容易'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='FitzGerald Gym、Olympic規模室内プール(6レーン)、フィットネスセンター、テニスコート(室内外)' LIMIT 1), 'ECC / 2024年：30勝19敗(記録更新)。3年連続ECC選手権決勝進出', '監督Reardon：通算400勝達成。All-ECC選手42名、All-Region11名、All-American2名育成', 'ECC / 2024年：30勝19敗(記録更新)。3年連続ECC選手権決勝進出 監督Reardon：通算400勝達成。All-ECC選手42名、All-Region11名、All-American2名育成', 'Hennekels Stadium：天然芝。改修工事進行中(総額$1000万+)', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('BIPOC97%(HBCU)。70カ国以上から留学生在籍', 'Hansel Tookes Rec Center(39000sqft)：15000sqftフィットネス、ロッククライミング、人工芝、サンドバレー。Lawson Multipurpose Center(135000sqft)', 'Center for Global Engagement：大規模HBCUとして国際学生サポート体制あり', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='タラハシー(州都)：FSU CollegeTown(飲食・ライブ音楽)、Cascades Park(屋外コンサート)、Railroad Square(アート地区)、District 850(ボウリング・アーケード)'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Hansel Tookes Rec Center(39000sqft)：15000sqftフィットネス、ロッククライミング、人工芝、サンドバレー。Lawson Multipurpose Center(135000sqft)' LIMIT 1), 'SWAC / 2025年：SWAC選手権決勝進出。8-1の好スタート', '監督Shouppe：21年間ピッチングコーチ経験。MEAC選手権2回、SWAC1回優勝。NCAA Regional3回出場', 'SWAC / 2025年：SWAC選手権決勝進出。8-1の好スタート 監督Shouppe：21年間ピッチングコーチ経験。MEAC選手権2回、SWAC1回優勝。NCAA Regional3回出場', 'Moore-Kittles Baseball Complex(1983)：500名収容、天然芝、ライト完備、電子スコアボード', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人69%, ラテン系11%, 黒人4%, アジア3%, BIPOC22%。61カ国から留学生3.1%', 'McCann Rec Center(140000sqft)：8ロッカールーム、Precorカーディオ、21Cybexウエイト、室内プール、強度トレーニングセンター。2019年$200万改修', 'トランスファー学生向けサポートプログラムあり', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='ポーキプシー(ハドソン川沿い)：Walkway Over Hudson(世界最長歩行者橋)、ファーマーズマーケット、醸造所、Bardavon Opera House、ゲティスバーグ(10分)、フレデリック(25分)'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='McCann Rec Center(140000sqft)：8ロッカールーム、Precorカーディオ、21Cybexウエイト、室内プール、強度トレーニングセンター。2019年$200万改修' LIMIT 1), 'MAAC / 2024-25：2年連続MAAC選手権進出。毎年成績向上中', '監督Ratchford：2017年MAACチャンピオンシップ・NCAA Regional経験。毎シーズン成績向上', 'MAAC / 2024-25：2年連続MAAC選手権進出。毎年成績向上中 監督Ratchford：2017年MAACチャンピオンシップ・NCAA Regional経験。毎シーズン成績向上', 'McCann Baseball Field(1992)：天然芝350名収容。2026年Heritage Financial Parkで12試合開催。新屋内打撃施設', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('BIPOC75%(HSI指定)。73カ国から留学生', '20以上のスポーツ施設。複合レクリエーション施設', 'ISS Office：1000人以上の留学生サポート。1対1アドバイザリー、ビザ支援。ISS@fdu.edu', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='ティーネック(NYCから25マイル)：映画館、ライブ音楽(Mexicali Live)、公園(Votee Park)、蝶館'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='20以上のスポーツ施設。複合レクリエーション施設' LIMIT 1), 'NEC / スケジュール確認済み', 'アームケア・アクティベーション、投球プログラム、デイリースキルワーク。チームディフェンス統合練習', 'NEC / スケジュール確認済み アームケア・アクティベーション、投球プログラム、デイリースキルワーク。チームディフェンス統合練習', 'Naimoli Family Baseball Complex(2011)：合成芝(内外野)、専用ダッグアウト・ケージ・ブルペン', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人43%, BIPOC58%, 留学生11%(2151名)。110カ国以上', 'Carol Soffer屋内練習施設($4000万)、Schwartz Center(30000sqft)、レクリエーション(クライミング・カヤック・スキューバ等)', 'ISSS：2725名の国際学生・研究者サポート。オリエンテーション、ビザ、保険、再入国支援', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='コーラルゲーブルズ：Miracle Mile(ショッピング・ダイニング)、Gablestage(映画館)、Fairchild植物園、月初金曜アート夜(無料)、ビーチ'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Carol Soffer屋内練習施設($4000万)、Schwartz Center(30000sqft)、レクリエーション(クライミング・カヤック・スキューバ等)' LIMIT 1), 'ACC / 2026年：D1Baseball 17位、USA Today 16位。9勝0敗スタート(.379打率)', '最新投球分析システム。複数角度動画記録・分析', 'ACC / 2026年：D1Baseball 17位、USA Today 16位。9勝0敗スタート(.379打率) 最新投球分析システム。複数角度動画記録・分析', 'Alex Rodriguez Park at Mark Light Field：5000名。$700万改修：最新屋内打撃施設、スコアボード、栄養センター', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人68%, BIPOC32%', 'キャンパス内レクリエーション施設。20マイル圏内に134の無料/安価な活動', '国際学生コーディネーター：Brandon Rockwell。メリット奨学金対象。健康保険推奨', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='エミッツバーグ：Ott House Pub(ビール・音楽)、Catoctin Mountain Park(ハイキング)、Cunningham Falls(滝・水泳)、ゲティスバーグ(10分)、フレデリック(25分・マイナーリーグ野球)'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='キャンパス内レクリエーション施設。20マイル圏内に134の無料/安価な活動' LIMIT 1), 'MAAC / 2022年NECから移行', '詳細は限定的', 'MAAC / 2022年NECから移行 詳細は限定的', 'E.T. Straw Family Stadium(2007)：500名。2017年改修：人工芝内野。$550000+資金調達', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人50%, ヒスパニック23%, アジア14%, 黒人1%', 'Rec Center：20000sqft+フィットネス、3線屋内トラック、MAC、マットルーム。月-金5:30am-12:30am', '国際プログラム部門あり(詳細は要確認)', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='サンルイスオビスポ：ダウンタウン探索、Bishop Peak登山、木曜農家市場、ワイナリー(Edna Valley)、ビーチ(20分)、醸造所'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Rec Center：20000sqft+フィットネス、3線屋内トラック、MAC、マットルーム。月-金5:30am-12:30am' LIMIT 1), 'Big West / 2025年：43勝19敗(Big West優勝)。NCAA準決勝進出', 'KinaTrax導入(NCAA mid-major初)：マーカーレス動作キャプチャ・AI分析。複数MLBドラフト指名', 'Big West / 2025年：43勝19敗(Big West優勝)。NCAA準決勝進出 KinaTrax導入(NCAA mid-major初)：マーカーレス動作キャプチャ・AI分析。複数MLBドラフト指名', 'Robin Baggett Stadium：最高級施設。LEDビデオボード36ftx20ft。Dignity Health Clubhouse(2020、10000sqft2階建)：ラウンジ・キッチン・ロッカー・冷浴', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('白人52%, ヒスパニック23%, アジア6%, BIPOC36%。48カ国代表', 'Wiegand Fitness Center、Murchison Gym、Names Aquatics Center(新改装)、8線全天候トラック', '国際学生サービスリエゾン：Sarah Sagredo。F-1ビザサポート。housing@westmont.edu', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='サンタバーバラ：サーフィン(Rincon Point)、パドルボード(Harbor)、Funk Zone(飲食・醸造所30軒)、日曜アート(200+アーティスト)、ホエールウォッチング'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Wiegand Fitness Center、Murchison Gym、Names Aquatics Center(新改装)、8線全天候トラック' LIMIT 1), 'NCAA D2(2023年NAIA卒業) / 2025年：43勝14敗(PacWest優勝)。2023年NAIAナショナルチャンピオン', '監督Svagdis：29年経歴。10回カンファレンスタイトル。9回Coach of the Year', 'NCAA D2(2023年NAIA卒業) / 2025年：43勝14敗(PacWest優勝)。2023年NAIAナショナルチャンピオン 監督Svagdis：29年経歴。10回カンファレンスタイトル。9回Coach of the Year', 'Russell Carr Field：天然芝(2010改装)', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES ('ヒスパニック49%, アジア22%, 白人16%, 黒人2%(HSI指定)。43662名', 'Student Rec Center(95000sqft)：3屋内コート、プール(80度加温)、クライミングウォール(30ft)。在学生無料', 'ISS：F/Jステータス支援。Titan Dreamers Resource Center。CAPS個別カウンセリング。CARECEN無料移民法サービス', 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='フラートン・オレンジ郡：Fullerton Arboretum(26エーカー)、Downtown Fullerton(ナイトライフ)、Newport Bay(パドルボード)、Huntington Beach(30分)、Tanaka Farms'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Student Rec Center(95000sqft)：3屋内コート、プール(80度加温)、クライミングウォール(30ft)。在学生無料' LIMIT 1), 'Big West / MLBドラフト316名輩出(1968年以降)。2024年3名ドラフト指名', '2024年MLBドラフト3人(Rodriguez-Orioles、Morones-Royals、Yates-Orioles)。歴史的に投手輩出の名門', 'Big West / MLBドラフト316名輩出(1968年以降)。2024年3名ドラフト指名 2024年MLBドラフト3人(Rodriguez-Orioles、Morones-Royals、Yates-Orioles)。歴史的に投手輩出の名門', 'Goodwin Field：3500席。Titan Sports Complex内。ダイアモンド・ソフトボール・トラック・テニス完備', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Riverside', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Riverside' LIMIT 1), 'Mike', 'Burns', 'Mike Burns', 'michael.burns@ucr.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Saint Mary s College of California', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Saint Mary s College of California' LIMIT 1), 'Thomas', 'Caulfield', 'Thomas Caulfield', 'tbc8@stmarys-ca.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Tennessee at Martin', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Tennessee at Martin' LIMIT 1), 'Ryan', 'Jenkins', 'Ryan Jenkins', 'pjenki11@utm.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of New Orleans', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='LA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of New Orleans' LIMIT 1), 'Andrew', 'Gipson', 'Andrew Gipson', 'bgipson@uno.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Charleston', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Charleston' LIMIT 1), 'Mason', 'Thomas', 'Mason Thomas', 'masonthomas@ucwv.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Point Loma Nazarene University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Richmond', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Richmond' LIMIT 1), 'Mik', 'Aoki', 'Mik Aoki', 'mik.aoki@richmond.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Fullerton', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Irvine', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Irvine' LIMIT 1), 'CJ', 'Yogi', 'CJ Yogi', 'cyogi@uci.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Bakersfield', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Northridge', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of North Alabama', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of North Alabama' LIMIT 1), 'Mike', 'Keehn', 'Mike Keehn', 'mjkeehn@una.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of North Alabama', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of North Alabama' LIMIT 1), 'Jad', 'Prachniak', 'Jad Prachniak', 'jprachniak@una.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Arizona', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AZ'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Arizona' LIMIT 1), 'Trip', 'Couch', 'Trip Couch', 'rcouch1@email.arizona.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Arizona', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Arizona' LIMIT 1), 'William', 'Gaines', 'William Gaines', 'wagaines@email.arizona.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Texas Christian University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Texas Christian University' LIMIT 1), 'Kirk', 'Saarloos', 'Kirk Saarloos', 'k.saarloos@tcu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Queens University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Queens University' LIMIT 1), 'Jake', 'Hendrick', 'Jake Hendrick', 'hendrickj@queens.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California Polytechnic State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'College of Charleston', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Sam Houston State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Sam Houston State University' LIMIT 1), 'Shane', 'Wedd', 'Shane Wedd', 'swedd@shsu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'San Diego State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='San Diego State University' LIMIT 1), 'Shaun', 'Cole', 'Shaun Cole', 'goaztecsbaseball@sdsu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Stephen F. Austin State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Florida A\&M University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Florida A\&M University' LIMIT 1), 'Jamey', 'Shouppe', 'Jamey Shouppe', 'jamey.shouppe@famu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of San Francisco', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of San Francisco' LIMIT 1), 'Erik', 'Supplee', 'Erik Supplee', 'esupplee@usfca.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of San Francisco', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of San Francisco' LIMIT 1), 'Rob', 'DiToma', 'Rob DiToma', 'rditoma@usfca.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Lindenwood University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MO'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Lindenwood University' LIMIT 1), 'PJ', 'Finigan', 'PJ Finigan', 'pfinigan@lindenwood.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Nebraska Omaha', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NE'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Nebraska Omaha' LIMIT 1), 'Evan', 'Porter', 'Evan Porter', 'etporter@omavs.com', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Pepperdine University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Pepperdine University' LIMIT 1), 'David', 'Pierce', 'David Pierce', 'Baseball@rice.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Santa Clara University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Santa Clara University' LIMIT 1), 'Rusty', 'Filter', 'Rusty Filter', 'rfilter@scu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Post University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='CT'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Post University' LIMIT 1), 'Ray', 'Skjold', 'Ray Skjold', 'rskjold@post.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Mercy University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Harding University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='AR'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Harding University' LIMIT 1), 'Dr.', 'Patrick McGaha', 'Dr. Patrick McGaha', 'pmcgaha@harding.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Harding University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Harding University' LIMIT 1), 'Zack', 'Honey', 'Zack Honey', 'zhoney@harding.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Illinois Springfield', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Illinois Springfield' LIMIT 1), 'Seth', 'Masters', 'Seth Masters', 'smast4@uis.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Illinois Springfield', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Illinois Springfield' LIMIT 1), 'Will', 'Oberg', 'Will Oberg', 'wober2@uis.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Angelo State University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Texas at Tyler', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Southern New Hampshire University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='LA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Southern New Hampshire University' LIMIT 1), 'Chris', 'Shank', 'Chris Shank', 'c.shank1@snhu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Southern New Hampshire University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Southern New Hampshire University' LIMIT 1), 'Charlie', 'Fletcher', 'Charlie Fletcher', 'c.fletcher2@snhu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of North Georgia', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='GA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of North Georgia' LIMIT 1), 'KC', 'Brown', 'KC Brown', 'kevin.brown@ung.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Tuskegee University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Tampa', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Virginia Commonwealth University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Virginia Commonwealth University' LIMIT 1), 'Ryan', 'Terrill', 'Ryan Terrill', 'terrillr@vcu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Fullerton', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Stanford University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Stanford University' LIMIT 1), 'Thomas', 'Eager', 'Thomas Eager', 'teager@stanford.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Irvine', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Irvine' LIMIT 1), 'Ben', 'Orloff', 'Ben Orloff', 'borloff@uci.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Sacramento', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Stanford University' LIMIT 1), 'Jeanette', 'Morganti', 'Jeanette Morganti', 'jmorganti@stanford.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Stanford University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Stanford University' LIMIT 1), 'Steve', 'Rodriguez', 'Steve Rodriguez', 'smrodriguez@stanford.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Santa Barbara', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Santa Barbara' LIMIT 1), 'Justin', 'Jacome', 'Justin Jacome', 'Justin.Jacome@athletics.ucsb.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Fresno', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Riverside' LIMIT 1), 'Lloyd', 'Acosta', 'Lloyd Acosta', 'lloyd.acosta@ucr.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Davis', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Davis' LIMIT 1), 'Sky', 'Valenzuela', 'Sky Valenzuela', 'srkvalenzuela@ucdavis.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Irvine', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Irvine' LIMIT 1), 'Ryan', 'Johnston', 'Ryan Johnston', 'rjohnst1@uci.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Saint Mary s College of California', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Saint Mary s College of California' LIMIT 1), 'Daniel', 'Costanza', 'Daniel Costanza', 'djc7@stmarys-ca.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Saint Mary s College of California', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Saint Mary s College of California' LIMIT 1), 'Eric', 'Valenzuela', 'Eric Valenzuela', 'emv5@stmarys-ca.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Riverside', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Santa Barbara' LIMIT 1), 'Dylan', 'Jones', 'Dylan Jones', 'Dylan.Jones@athletics.ucsb.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Santa Barbara', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Santa Barbara' LIMIT 1), 'Kevin', 'Cannon', 'Kevin Cannon', 'kevin.cannon@athletics.ucsb.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Santa Barbara', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Santa Barbara' LIMIT 1), 'Matt', 'Fonteno', 'Matt Fonteno', 'Matt.Fonteno@athletics.ucsb.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Berkeley', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Berkeley' LIMIT 1), 'Mike', 'Neu', 'Mike Neu', 'mneu@berkeley.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Saint Mary s College of California', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Saint Mary s College of California' LIMIT 1), 'Jack', 'Meggs', 'Jack Meggs', 'jwm11@stmarys-ca.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Binghamton University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Xavier University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Xavier University' LIMIT 1), 'Billy', 'O''Conner', 'Billy O''Conner', 'oconnerw@xavier.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Charleston Southern University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Charleston Southern University' LIMIT 1), 'Karl', 'Kuhn', 'Karl Kuhn', 'kkuhn@csuniv.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Maryland, Baltimore County', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MD'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Maryland, Baltimore County' LIMIT 1), 'Liam', 'Bowen', 'Liam Bowen', 'bowen@umbc.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Stony Brook University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Stony Brook University' LIMIT 1), 'Jim', 'Martin', 'Jim Martin', 'james.martin@stonybrook.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Columbia University-Barnard College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Marist College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Marist College' LIMIT 1), 'Lance', 'Ratchford', 'Lance Ratchford', 'Lance.Ratchford@Marist.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Canisius University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Siena College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Siena College' LIMIT 1), 'Chris', 'Hamilton', 'Chris Hamilton', 'chamilton@siena.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Valparaiso University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Valparaiso University' LIMIT 1), 'Brian', 'Schmack', 'Brian Schmack', 'brian.schmack@valpo.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Wagner College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Wagner College' LIMIT 1), 'Craig', 'Noto', 'Craig Noto', 'craig.noto@wagner.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Western Illinois University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Western Illinois University' LIMIT 1), 'Terry', 'Davis', 'Terry Davis', 't-davis10@wiu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Tarleton State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of San Diego', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of San Diego' LIMIT 1), 'Brock', 'Ungricht', 'Brock Ungricht', 'bungricht@sandiego.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of San Diego', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of San Diego' LIMIT 1), 'Grady', 'Miller', 'Grady Miller', 'gradymiller@sandiego.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of San Diego', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of San Diego' LIMIT 1), 'Josh', 'Nicoloff', 'Josh Nicoloff', 'jnicoloff@sandiego.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Niagara University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Niagara University' LIMIT 1), 'Matt', 'Spatafora', 'Matt Spatafora', 'mspatafora@niagara.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Rider University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NJ'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Rider University' LIMIT 1), 'Barry', 'Davis', 'Barry Davis', 'bdavis@rider.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Le Moyne University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Le Moyne University' LIMIT 1), 'Scott', 'Cassidy', 'Scott Cassidy', 'cassidsr@lemoyne.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Marshall University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='WV'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Marshall University' LIMIT 1), 'Greg', 'Beals', 'Greg Beals', 'bealsg@marshall.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Florida A\&M University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Monterey Bay', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Chico State University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Belmont Abbey College', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Belmont Abbey College' LIMIT 1), 'Chris', 'Anderson', 'Chris Anderson', 'chrisanderson@bac.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Francis Marion University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Francis Marion University' LIMIT 1), 'Jeff', 'Jefferson', 'Jeff Jefferson', 'jeff.jefferson@fmarion.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Mercy University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Molloy University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Harding University' LIMIT 1), 'Zach', 'Beasley', 'Zach Beasley', 'zbeasley@harding.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Davenport University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Davenport University' LIMIT 1), 'Kevin', 'Tidey', 'Kevin Tidey', 'kevin.tidey@davenport.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Grand Valley State University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Grand Valley State University' LIMIT 1), 'Jordan', 'Keur', 'Jordan Keur', 'keurj@gvsu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Wayne State University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Wayne State University' LIMIT 1), 'Seth', 'Marano', 'Seth Marano', 'hg0498@wayne.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Illinois Springfield', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Illinois Springfield' LIMIT 1), 'Chris', 'Rodriguez', 'Chris Rodriguez', 'crodr100@uis.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Indianapolis', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='IN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Indianapolis' LIMIT 1), 'Al', 'Ready', 'Al Ready', 'readyaj@uindy.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Maryville College', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='TN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Mississippi College', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='MS'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Mississippi College' LIMIT 1), 'Jeremy', 'Haworth', 'Jeremy Haworth', 'jshaworth@mc.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of West Florida', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Central Missouri', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='MO'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Central Missouri' LIMIT 1), 'Kyle', 'Crookes', 'Kyle Crookes', 'crookes@ucmo.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Central Missouri', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Central Missouri' LIMIT 1), 'Eli', 'McFadden', 'Eli McFadden', 'emcfadden@ucmo.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Central Missouri', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Central Missouri' LIMIT 1), 'Alex', 'Backhaus', 'Alex Backhaus', 'backhaus@ucmo.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Adelphi University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Augustana University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='SD'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Augustana University' LIMIT 1), 'Tim', 'Huber', 'Tim Huber', 'tim.huber@augie.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Westmont College', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Seton Hill University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='PA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Seton Hill University' LIMIT 1), 'Mike', 'Zito', 'Mike Zito', 'mzito@setonhill.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Wingate University', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Wingate University' LIMIT 1), 'David', 'Nash', 'David Nash', 'd.nash@wingate.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Tampa', NULL, 
(SELECT id FROM divisions WHERE name='D2'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Virginia Commonwealth University' LIMIT 1), 'Sean', 'Thompson', 'Sean Thompson', 'thompsonsw2@vcu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'St. Bonaventure University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='St. Bonaventure University' LIMIT 1), 'Cody', 'Shimp', 'Cody Shimp', 'shimpcj18@bonaventure.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'St. Bonaventure University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='St. Bonaventure University' LIMIT 1), 'Jason', 'Rathbun', 'Jason Rathbun', 'jrathbun@sbu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Stanford University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Stanford University' LIMIT 1), 'Ryan', 'Kirby', 'Ryan Kirby', 'rkirby2@stanford.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Irvine', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Irvine' LIMIT 1), 'Erich', 'Pfohl', 'Erich Pfohl', 'epfohl@uci.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Irvine', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Davis' LIMIT 1), 'Andrew', 'Ayers', 'Andrew Ayers', 'agayers@ucdavis.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Davis', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Davis' LIMIT 1), 'Leticia', 'Valenzuela', 'Leticia Valenzuela', 'ldcisneros@ucdavis.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Davis', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Davis' LIMIT 1), 'Zack', 'Thornton', 'Zack Thornton', 'zjthornton@ucdavis.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Fresno', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Saint Mary s College of California' LIMIT 1), 'Daniel', 'Molinari', 'Daniel Molinari', 'dm81@stmarys-ca.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Berkeley', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Berkeley' LIMIT 1), 'Andrew', 'Evans', 'Andrew Evans', 'andrewevans@berkeley.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Santa Barbara', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Santa Barbara' LIMIT 1), 'Gianni', 'Bloom', 'Gianni Bloom', 'gianni.bloom@athletics.ucsb.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of California, Santa Barbara', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of California, Santa Barbara' LIMIT 1), 'Spencer', 'Erdman', 'Spencer Erdman', 'spencer.erdman@athletics.ucsb.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Binghamton University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Maine', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='ME'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Maine' LIMIT 1), 'Nick', 'Derba', 'Nick Derba', 'Steve.Derba@maine.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Arkansas State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AR'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Baylor University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Seton Hall University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NJ'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Seton Hall University' LIMIT 1), 'Rob', 'Sheppard', 'Rob Sheppard', 'robert.sheppard@shu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'St. John''s University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='St. John''s University' LIMIT 1), 'Mike', 'Hampton', 'Mike Hampton', 'hamptonm@stjohns.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Villanova University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='PA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Hawaii, Manoa', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='HI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Hawaii, Manoa' LIMIT 1), 'Keith', 'Zuniga', 'Keith Zuniga', 'zunigak@hawaii.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Hawaii, Manoa', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Hawaii, Manoa' LIMIT 1), 'Dave', 'Nakama', 'Dave Nakama', 'dnakama4@hawaii.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'California State University, Long Beach', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Hofstra University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Hofstra University' LIMIT 1), 'Frank', 'Catalanotto', 'Frank Catalanotto', 'frank.j.catalanotto@hofstra.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of North Carolina Wilmington', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of North Carolina Wilmington' LIMIT 1), 'Randy', 'Hood', 'Randy Hood', 'hoodr@uncw.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'College of William & Mary', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Sam Houston State University' LIMIT 1), 'Hayden', 'Evans', 'Hayden Evans', 'shsubaseballcamps@gmail.com', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Wright State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Wright State University' LIMIT 1), 'Alex', 'Sogard', 'Alex Sogard', 'alex.sogard@wright.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Youngstown State University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Youngstown State University' LIMIT 1), 'Trevor', 'Charpie', 'Trevor Charpie', 'tcharpie@ysu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Columbia University-Barnard College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Cornell University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Yale University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CT'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Yale University' LIMIT 1), 'Brian', 'Hamm', 'Brian Hamm', 'brian.hamm@yale.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Manhattan College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Manhattan College' LIMIT 1), 'Steven', 'Rosen', 'Steven Rosen', 'srosen02@manhattan.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Manhattan College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Manhattan College' LIMIT 1), 'Will', 'Hesslink', 'Will Hesslink', 'whesslink01@manhattan.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Siena College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Siena College' LIMIT 1), 'Alex', 'Jurczynski', 'Alex Jurczynski', 'ajurczynski@siena.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Toledo', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Toledo' LIMIT 1), 'Rob', 'Reinstetle', 'Rob Reinstetle', 'robert.reinstetle@utoledo.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Western Michigan University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Western Michigan University' LIMIT 1), 'Billy', 'Gernon', 'Billy Gernon', 'billy.gernon@wmich.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Southern Illinois University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Southern Illinois University' LIMIT 1), 'Lance', 'Rhodes', 'Lance Rhodes', 'salukibaseball@siu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Long Island University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Long Island University' LIMIT 1), 'Dan', 'Pirillo', 'Dan Pirillo', 'daniel.pirillo@liu.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'United States Military Academy', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='United States Military Academy' LIMIT 1), 'Chris', 'Tracz', 'Chris Tracz', 'christopher.Tracz@westpoint.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of Tennessee', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of Tennessee' LIMIT 1), 'Tony', 'Vitello', 'Tony Vitello', 'tvitello@utk.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Auburn University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Virginia Military Institute', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Western Carolina University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Wofford College', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Wofford College' LIMIT 1), 'J.J.', 'Edwards', 'J.J. Edwards', 'edwardsje@wofford.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Houston Christian University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Houston Christian University' LIMIT 1), 'Clay', 'VanderLaan', 'Clay VanderLaan', 'cvanderlaan@hc.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Lamar University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Lamar University' LIMIT 1), 'Scott', 'Hatten', 'Scott Hatten', 'scott.hatten@lamar.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Lamar University', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='Lamar University' LIMIT 1), 'Will', 'Davis', 'Will Davis', 'wdavis12@lamar.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of the Incarnate Word', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of the Incarnate Word' LIMIT 1), 'Greg', 'Evans', 'Greg Evans', 'gsevans@uiwtx.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of the Incarnate Word', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of the Incarnate Word' LIMIT 1), 'Butch', 'Rea', 'Butch Rea', 'jrea@uiwtx.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of the Incarnate Word', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of the Incarnate Word' LIMIT 1), 'Ryan', 'Shotzberger', 'Ryan Shotzberger', 'shotzber@uiwtx.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'University of the Incarnate Word', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='University of the Incarnate Word' LIMIT 1), 'Andrew', 'Stumph', 'Andrew Stumph', 'stumph@uiwtx.edu', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'Texas A\&M University-Corpus Christi', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, '①最寄空港', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='州'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='①最寄空港' LIMIT 1), '①空港距離(分)', '①30分以内', '①空港距離(分) ①30分以内', '②年間平均気温(°F)', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'XNA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AR'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='XNA' LIMIT 1), '30', 'Yes', '30 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LFT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='LA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LFT' LIMIT 1), '4', 'Yes', '4 Yes', '67', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MEM', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MS'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MEM' LIMIT 1), '82', 'No', '82 No', '64', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MIA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MIA' LIMIT 1), '14', 'Yes', '14 Yes', '72', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TLH', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TLH' LIMIT 1), '10', 'Yes', '10 Yes', '72', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ATL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='GA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ATL' LIMIT 1), '20', 'Yes', '20 Yes', '64', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'RDU', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='RDU' LIMIT 1), '20', 'Yes', '20 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'RDU', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='RDU' LIMIT 1), '30', 'Yes', '30 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CAE', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CAE' LIMIT 1), '10', 'Yes', '10 Yes', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ACT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ACT' LIMIT 1), '15', 'Yes', '15 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TUS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AZ'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TUS' LIMIT 1), '16', 'Yes', '16 Yes', '61', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'HOU', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='HOU' LIMIT 1), '25', 'Yes', '25 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DFW', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DFW' LIMIT 1), '25', 'Yes', '25 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LBB', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LBB' LIMIT 1), '13', 'Yes', '13 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MCO', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MCO' LIMIT 1), '28', 'Yes', '28 Yes', '72', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'GNV', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='GNV' LIMIT 1), '15', 'Yes', '15 Yes', '72', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'GSO', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='GSO' LIMIT 1), '15', 'Yes', '15 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MFE', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MFE' LIMIT 1), '10', 'Yes', '10 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ATL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ATL' LIMIT 1), '15', 'Yes', '15 Yes', '64', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DFW', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DFW' LIMIT 1), '20', 'Yes', '20 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LAS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NV'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LAS' LIMIT 1), '10', 'Yes', '10 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'FAT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='FAT' LIMIT 1), '10', 'Yes', '10 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TRI', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TRI' LIMIT 1), '15', 'Yes', '15 Yes', '58', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'AVL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='AVL' LIMIT 1), '80', 'No', '80 No', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'HNL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='HI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='HNL' LIMIT 1), '20', 'Yes', '20 Yes', '70', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ATL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ATL' LIMIT 1), '30', 'Yes', '30 Yes', '64', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MIA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MIA' LIMIT 1), '15', 'Yes', '15 Yes', '72', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'PHX', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AZ'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='PHX' LIMIT 1), '19', 'Yes', '19 Yes', '61', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CHS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CHS' LIMIT 1), '15', 'Yes', '15 Yes', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BWI', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MD'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BWI' LIMIT 1), '10', 'Yes', '10 Yes', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'GSP', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='SC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='GSP' LIMIT 1), '25', 'Yes', '25 Yes', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'JAN', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MS'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='JAN' LIMIT 1), '10', 'Yes', '10 Yes', '64', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DAB', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='FL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DAB' LIMIT 1), '10', 'Yes', '10 Yes', '72', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SLC', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='UT'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SLC' LIMIT 1), '51', 'No', '51 No', '49', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MCI', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='KS'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MCI' LIMIT 1), '120', 'No', '120 No', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CAK', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CAK' LIMIT 1), '15', 'Yes', '15 Yes', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TOL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TOL' LIMIT 1), '25', 'Yes', '25 Yes', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BGM', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BGM' LIMIT 1), '10', 'Yes', '10 Yes', '47', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'GSP', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='GSP' LIMIT 1), '45', 'No', '45 No', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CHO', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CHO' LIMIT 1), '25', 'Yes', '25 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'GSO', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='RDU' LIMIT 1), '24', 'Yes', '24 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SDF', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='KY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SDF' LIMIT 1), '10', 'Yes', '10 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'PHX', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='PHX' LIMIT 1), '36', 'No', '36 No', '61', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CVG', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CVG' LIMIT 1), '20', 'Yes', '20 Yes', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TUL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OK'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TUL' LIMIT 1), '70', 'No', '70 No', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CKB', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='WV'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CKB' LIMIT 1), '10', 'Yes', '10 Yes', '53', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DTW', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DTW' LIMIT 1), '30', 'Yes', '30 Yes', '45', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CMH', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CMH' LIMIT 1), '14', 'Yes', '14 Yes', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LNK', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NE'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LNK' LIMIT 1), '10', 'Yes', '10 Yes', '49', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CMI', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CMI' LIMIT 1), '15', 'Yes', '15 Yes', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LAN', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LAN' LIMIT 1), '15', 'Yes', '15 Yes', '45', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DCA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MD'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DCA' LIMIT 1), '28', 'Yes', '28 Yes', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MSP', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MSP' LIMIT 1), '16', 'Yes', '16 Yes', '42', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SCE', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='PA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SCE' LIMIT 1), '10', 'Yes', '10 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ATL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ATL' LIMIT 1), '96', 'No', '96 No', '64', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BHM', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BHM' LIMIT 1), '60', 'No', '60 No', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LEX', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='KY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LEX' LIMIT 1), '11', 'Yes', '11 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TYS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TYS' LIMIT 1), '16', 'Yes', '16 Yes', '58', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ATL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ATL' LIMIT 1), '90', 'No', '90 No', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TUL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TUL' LIMIT 1), '15', 'Yes', '15 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SNA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SNA' LIMIT 1), '15', 'Yes', '15 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LAX', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LAX' LIMIT 1), '30', 'Yes', '30 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BUR', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BUR' LIMIT 1), '15', 'Yes', '15 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SMF', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SMF' LIMIT 1), '15', 'Yes', '15 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'AZO', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='AZO' LIMIT 1), '10', 'Yes', '10 Yes', '45', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TOL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='TOL' LIMIT 1), '15', 'Yes', '15 Yes', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ORD', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ORD' LIMIT 1), '25', 'Yes', '25 Yes', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LGB', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LGB' LIMIT 1), '10', 'Yes', '10 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SGF', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MO'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SGF' LIMIT 1), '10', 'Yes', '10 Yes', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SHV', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='LA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SHV' LIMIT 1), '70', 'No', '70 No', '67', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CVG', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CVG' LIMIT 1), '10', 'Yes', '10 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MBS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MBS' LIMIT 1), '30', 'Yes', '30 Yes', '45', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CAK', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'RFD', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='RFD' LIMIT 1), '15', 'Yes', '15 Yes', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BMI', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BMI' LIMIT 1), '10', 'Yes', '10 Yes', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SJC', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SJC' LIMIT 1), '5', 'Yes', '5 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ABQ', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NM'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ABQ' LIMIT 1), '10', 'Yes', '10 Yes', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'RNO', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NV'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='RNO' LIMIT 1), '10', 'Yes', '10 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'AVL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='AVL' LIMIT 1), '50', 'No', '50 No', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LCH', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='LA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LCH' LIMIT 1), '10', 'Yes', '10 Yes', '67', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BPT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BPT' LIMIT 1), '5', 'Yes', '5 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MSY', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='LA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MSY' LIMIT 1), '15', 'Yes', '15 Yes', '67', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SAV', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='GA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SAV' LIMIT 1), '55', 'No', '55 No', '64', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MSY', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MSY' LIMIT 1), '60', 'No', '60 No', '67', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MGM', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MGM' LIMIT 1), '50', 'No', '50 No', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MGM', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MGM' LIMIT 1), '10', 'Yes', '10 Yes', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DFW', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DFW' LIMIT 1), '80', 'No', '80 No', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CMH', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CMH' LIMIT 1), '80', 'No', '80 No', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BDL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CT'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BDL' LIMIT 1), '30', 'Yes', '30 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'IAH', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='IAH' LIMIT 1), '60', 'No', '60 No', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LYH', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LYH' LIMIT 1), '10', 'Yes', '10 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'PHL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='PA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='PHL' LIMIT 1), '20', 'Yes', '20 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SAN', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SAN' LIMIT 1), '16', 'Yes', '16 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SHD', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SHD' LIMIT 1), '25', 'Yes', '25 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ORF', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ORF' LIMIT 1), '12', 'Yes', '12 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'AUS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='AUS' LIMIT 1), '40', 'No', '40 No', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'JFK', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='JFK' LIMIT 1), '15', 'Yes', '15 Yes', '47', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'AVL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='AVL' LIMIT 1), '20', 'Yes', '20 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DAY', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DAY' LIMIT 1), '15', 'Yes', '15 Yes', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BDL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BDL' LIMIT 1), '15', 'Yes', '15 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CRP', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CRP' LIMIT 1), '15', 'Yes', '15 Yes', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'FAR', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='ND'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='FAR' LIMIT 1), '10', 'Yes', '10 Yes', '41', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'OMA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NE'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='OMA' LIMIT 1), '10', 'Yes', '10 Yes', '49', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BTR', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='LA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BTR' LIMIT 1), '10', 'Yes', '10 Yes', '67', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'HSV', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='AL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='HSV' LIMIT 1), '10', 'Yes', '10 Yes', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ONT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ONT' LIMIT 1), '20', 'Yes', '20 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'EWR', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NJ'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='EWR' LIMIT 1), '20', 'Yes', '20 Yes', '53', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SNA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SNA' LIMIT 1), '10', 'Yes', '10 Yes', '59', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'PIT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='PA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='PIT' LIMIT 1), '20', 'Yes', '20 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SYR', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SYR' LIMIT 1), '10', 'Yes', '10 Yes', '47', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CID', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CID' LIMIT 1), '20', 'Yes', '20 Yes', '47', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MKE', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='WI'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MKE' LIMIT 1), '15', 'Yes', '15 Yes', '44', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'JFK', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='JFK' LIMIT 1), '25', 'Yes', '25 Yes', '47', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'TLH', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CHS' LIMIT 1), '20', 'Yes', '20 Yes', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'YNG', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='OH'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='YNG' LIMIT 1), '15', 'Yes', '15 Yes', '51', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BGR', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='ME'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BGR' LIMIT 1), '10', 'Yes', '10 Yes', '42', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BTV', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VT'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BTV' LIMIT 1), '10', 'Yes', '10 Yes', '43', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ROA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ROA' LIMIT 1), '50', 'No', '50 No', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SBN', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SBN' LIMIT 1), '15', 'Yes', '15 Yes', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'MCI', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='MCI' LIMIT 1), '50', 'No', '50 No', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'IND', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IN'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='IND' LIMIT 1), '61', 'No', '61 No', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'IND', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='IND' LIMIT 1), '78', 'No', '78 No', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'EWR', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='EWR' LIMIT 1), '35', 'No', '35 No', '53', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BOS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='MA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BOS' LIMIT 1), '10', 'Yes', '10 Yes', '48', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'JFK', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='JFK' LIMIT 1), '30', 'Yes', '30 Yes', '47', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'HVN', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='CT'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='HVN' LIMIT 1), '10', 'Yes', '10 Yes', '50', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'ELP', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NM'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='ELP' LIMIT 1), '50', 'No', '50 No', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'IND', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='IND' LIMIT 1), '65', 'No', '65 No', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'STL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='IL'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='STL' LIMIT 1), '25', 'Yes', '25 Yes', '52', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BNA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='KY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BNA' LIMIT 1), '65', 'No', '65 No', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'BHM', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='BHM' LIMIT 1), '80', 'No', '80 No', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DTW', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DTW' LIMIT 1), '35', 'No', '35 No', '45', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SHV', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SHV' LIMIT 1), '75', 'No', '75 No', '67', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'GGG', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='TX'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='GGG' LIMIT 1), '60', 'No', '60 No', '66', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'HTS', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='WV'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='HTS' LIMIT 1), '14', 'Yes', '14 Yes', '53', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'SLC', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='SLC' LIMIT 1), '45', 'No', '45 No', '49', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DTW', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DTW' LIMIT 1), '25', 'Yes', '25 Yes', '45', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'RIC', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='VA'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='RIC' LIMIT 1), '15', 'Yes', '15 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'STL', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='STL' LIMIT 1), '20', 'Yes', '20 Yes', '55', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CLT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NC'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CLT' LIMIT 1), '25', 'Yes', '25 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'DCA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='DCA' LIMIT 1), '15', 'Yes', '15 Yes', '56', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'LGA', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
(SELECT id FROM states WHERE code='NY'), 'integrated_master')
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='LGA' LIMIT 1), '20', 'Yes', '20 Yes', '47', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'CLT', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='CLT' LIMIT 1), '30', 'Yes', '30 Yes', '63', 'Head Coach')
ON CONFLICT DO NOTHING;
INSERT INTO universities (external_id, name, true_name, division_id, state_id, data_source)
VALUES (NULL, 'GSO', NULL, 
(SELECT id FROM divisions WHERE name='D1'),
...
ON CONFLICT DO NOTHING;
INSERT INTO coaches (university_id, first_name, last_name, full_name, email, role)
VALUES ((SELECT id FROM universities WHERE name='GSO' LIMIT 1), '20', 'Yes', '20 Yes', '60', 'Head Coach')
ON CONFLICT DO NOTHING;
